...
export const setReg = createAsyncThunk("reg", async (data) => {
    try {
        const response = await Axios.post("https://todo-backend-eosin.vercel.app/register", data)
...
const register = createSlice({
    ...
    initialState: {
        ...
        repeatPassword: '',
        errors: null,
        loading: null, // Initially set loading to false
        modalIsOpen: null // Initially set modalIsOpen to false
    },
    reducers: {
